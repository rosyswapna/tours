...
<html class="bg-black">
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box">
            ...
            <?php echo form_open(base_url().'login/login','class=form_login');?>
		    ...
		    <?php  if( $this->session->userdata('isloginAttemptexceeded')==true){  ?>     
                    <div class="form-group">
			<div name="captcha_div" id="captcha_div">
			<?php echo form_input(array('name' => 'captcha','class'=>'captcha form-control','placeholder'=>'Captcha')).nbs(3); ?><img id="captcha_id" src="<?php echo base_url().'captcha';?>"/>
			</div>
