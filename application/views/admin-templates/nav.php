			...
			<li class="treeview">
                            ...
                            <ul class="treeview-menu">
                            <li><a href="<?php echo base_url().'front-desk/tour/packages';?>"><i class="fa fa-angle-double-right"></i>Manage Packages</a></li> 
						...
						<li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url().'front-desk/tour/booking/TA';?>"><i class="fa fa-angle-double-right"></i>New Trip</a></li>
						<li><a href="<?php echo base_url().'front-desk/tour/list';?>"><i class="fa fa-angle-double-right"></i>Trip Bookings</a></li>
