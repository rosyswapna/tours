...
$('select, .trip-service-status').change(function(){ 
...
$('.vehicle-list').on('keydown',function(){
	...
	$('.itinerary #add-travel').click(function(){ 
		...
		var input_data={};
			input_data['travel_date']=$('#travel_date').val();
			input_data['destination_priority']=$('#destination_priority').val();
		...
		if(error=='false' && error_combo=='false'){
			...
			var gINVALID=-1;
			if(row_id >gINVALID && destination_section_id> gINVALID){ 
			$("#tab-display").css("display","none");
			}
	...
	$('.itinerary #add-accommodation').click(function(){
		...
		var input_data={};
			input_data['accommodation_date']=$('#accommodation_date').val();
			error=isVarNull(input_data);
			error_combo=isVarNullCombo(combo_data);
		if(error=='false' && error_combo=='false'){
			resetComboErrorFields(combo_data);	
			...
			var gINVALID=-1;
			if(row_id >gINVALID && accommodation_section_id> gINVALID){ 
			$("#tab-display").css("display","none");
			}
	...
	$('.itinerary #add-service').click(function(){
		...
		var input_data={};
			input_data['service_date']=$('#service_date').val();
			error=isVarNull(input_data);
			error_combo=isVarNullCombo(combo_data);
		if(error=='false' && error_combo=='false'){
			resetComboErrorFields(combo_data);
			...
			var gINVALID=-1;
			if(row_id >gINVALID && service_section_id> gINVALID){ 
			$("#tab-display").css("display","none");
			}
	...
	$('.itinerary #add-vehicle').click(function(){
		...
		var input_data={};
			input_data['vehicle_date']=$('#vehicle_date').val();
			error=isVarNull(input_data);
			error_combo=isVarNullCombo(combo_data);
		if(error=='false' && error_combo=='false'){
			resetComboErrorFields(combo_data);
		...
		var gINVALID=-1;
			if(row_id >gINVALID && vehicle_section_id> gINVALID){ 
			$("#tab-display").css("display","none");
			}
		   ...
		   table:table
			...
			if(data!=false){
				...
				if(tab=="t_tab"){ 
					...
					$(".tour-travel-tab #travel_date").val(itinerary);
				...
				//service-tab values
					...
					$(href).trigger('click');
					$(".tour-service-tab #service_row_id").val(row_id);
					$(".tour-service-tab #service_itinerary_id").val(data.itinerary_id);
					$(".tour-service-tab #service_section_id").val(data.id);
					
					$(".tour-service-tab #service_date").val(itinerary);
				...
				//vehicle-tab values
					...
					$(".tour-vehicle-tab #vehicle_date").val(itinerary);
